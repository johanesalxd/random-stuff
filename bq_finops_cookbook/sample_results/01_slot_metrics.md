...
|---|---|---|---|---|---|
| JOBS_TIMELINE slot-ms semantics | https://docs.cloud.google.com/bigquery/docs/information-schema-jobs-timeline | 2026-07-15 | Declared synthetic analysis window | PASS | Slot usage is not autoscaling billing |
