-- ============================================================================
-- ACT 3: OPERATIONAL EXECUTION - Google Maps API Integration (K-Means Version)
-- ============================================================================
-- This query demonstrates the "Hybrid Architecture" by combining BigQuery's
-- K-Means clustering with Google Maps API's tactical execution.
--
-- PREREQUISITES:
-- 1. Run 00_create_kmeans_model.sql to create the K-Means model
-- 2. Deploy the Cloud Function (see cloud_function/ directory)
-- 3. Create BigQuery Remote Function connection
-- 4. Update the placeholders below with your project details
-- ============================================================================
...
-- ============================================================================
-- STEP 2: The Hybrid Query - BigQuery K-Means + Google Maps
-- ============================================================================

WITH
  -- ACT 1: STRATEGIC PLANNING (BigQuery K-Means)
  -- Cluster 100 stops into 10 balanced territories
  raw_stations AS (
    SELECT
      station_id,
      name,
...
-- ============================================================================
-- OUTPUT: Compare BigQuery K-Means vs Google Maps routes
-- ============================================================================
...
SELECT
  ...
  CONCAT(
    'BQ K-Means Route: ', CAST(bq_route_distance_km AS STRING), ' km (geodesic)'
  ) AS label,
  'BigQuery' AS source
FROM bq_routes
...
--    - BigQuery Route: Straight lines (strategic planning with K-Means)
--    - Google Maps Route: Road network (operational execution)
--
-- 5. Notice the difference:
--    - BigQuery K-Means: Balanced territories, fast, cheap, good for planning
...
/*
SELECT
  'BigQuery K-Means (Strategic)' AS approach,
...
-- TALKING POINTS:
-- ============================================================================
-- 1. "The red line is BigQuery's K-Means strategic plan - balanced and cheap"
-- 2. "The blue line is Google Maps' tactical execution - precise and driveable"
-- 3. "K-Means created more balanced territories than simple geohash sorting"
-- 4. "Notice how the blue line follows actual roads, not straight lines"
-- 5. "BigQuery processed 100 stops in milliseconds for fractions of a cent"
-- 6. "We only sent the final optimized stops to Maps API - cost optimization"
-- 7. "This hybrid approach gives us both ML-powered balance and street-level precision"
-- ============================================================================

-- ============================================================================
-- DEPLOYMENT CHECKLIST:
-- ============================================================================
-- [ ] K-Means model created (00_create_kmeans_model.sql)
