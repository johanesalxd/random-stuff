...
BEGIN
  ...
  -- Create temporary table with stops to visit
...
-- 2. "The greedy nearest-neighbor algorithm finds a good (not optimal) solution quickly"
-- 3. "Each stop is chosen as the closest unvisited point from the current location"
-- 4. "This approach works for small routes (<100 stops)"
-- 5. "For larger problems, use the geohash heuristic or Google Maps API"
-- 6. "Notice how the route avoids backtracking - it creates a logical path"
-- ============================================================================
