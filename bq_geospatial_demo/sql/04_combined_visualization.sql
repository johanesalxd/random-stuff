-- ============================================================================
-- COMBINED VISUALIZATION - All Demo Layers in One Query
-- ============================================================================
-- This query combines territory assignment, route sequencing, and statistics
-- into a single visualization for BigQuery Geo Viz.
--
...
-- TALKING POINTS:
-- ============================================================================
-- 1. "This single query shows the complete optimization pipeline"
-- 2. "10 color-coded territories, each with a logical route"
-- 3. "The large dots are zone centers - optimal depot locations"
-- 4. "Notice how routes avoid crossing each other - minimal overlap"
-- 5. "Total processing time: under 1 second for 500 stops"
...
-- 2. Add "Zone Center" layer - show clustering result
